...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
	...
	protected ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException ex,
		...
		String detail = "O corpoo da requisição está inválido. Verifique erro de sintaxe.";
	...
	private ResponseEntity<Object> handleMethodArgumentTypeException(MethodArgumentTypeMismatchException ex,
			HttpHeaders headers, HttpStatus status, WebRequest request) {
		ProblemType problemType = ProblemType.PARAMETRO_INVÁLIDO;

		String detail =  String.format("O prametro de URL '%s' recebeu o valor '%s' , que é de um tipo inválido. "
				+ "Corrija e informe um valor do tipo '%s' ", ex.getName(), ex.getValue(), ex.getRequiredType().getSimpleName());
	...
	protected ResponseEntity<Object> handleNoHandlerFoundException(NoHandlerFoundException ex, HttpHeaders headers,
		...
		if (ex instanceof NoHandlerFoundException) {
			return handleNoUrlFoundException((NoHandlerFoundException) ex, headers, status, request);
		}
		return super.handleNoHandlerFoundException(ex, headers, status, request);
	}

	private ResponseEntity<Object> handleNoUrlFoundException(NoHandlerFoundException ex, HttpHeaders headers,
			HttpStatus status, WebRequest request) {
